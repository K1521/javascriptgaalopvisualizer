...
ivec3 unpackVoxel(uvec3 packed) {
...
vec3 voxelToPosition(ivec3 voxelCoords) {
    ...
    vec3 t = vec3(voxelCoords) / 65536.0;
...
void main() {
    ...
    vec3 poshigh = voxelToPosition(parent + ivec3(1 << (16 - level))); // levels go from 0 to 10
