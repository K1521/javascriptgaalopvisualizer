...
\section{Ganja}
Ganja ist eine Library für geometrische Algebra die von vielen anderen Libraries zur Visualisierung benutzt wird. 
...
Im ersten Ansatz wird versucht zu interpretieren, ob das Objekt ein Punkt, Linie, Ebene, Kugel etc. darstellt und dann entsprechend visualisiert. Dieser Ansatz funktioniert vor allem in niedrig dimensionalen Algebren da in höherdimensionalen die Anzahl der möglichen geometrischen Objekte wächst. Deshalb benutze ich den zweiten Ansatz.
