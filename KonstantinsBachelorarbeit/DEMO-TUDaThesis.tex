...
\section{Hilfsmittel}
Diese Arbeit ist mein erstes Javaskript Projekt. Deshalb habe ich anfangs viel Code mittels ChatGPT von Python übersetzten, um zu sehen, wie der Code in Javaskript aussieht. Später habe ich Chatgpt außerdem zum Code review benutzt, und um Rechtschreibfehler zu finden. Weitere Hilfsmittel sind VSCode als IDE, und Excel für Diagramme.
...
Eine weitere möglichkeit ist die erweiterung der Software durch neue Methoden. Allerdings müsste dafür erst festgestellt werden welche Methoden in der Praxis gut funktionieren.
